...
\newcommand{\bullshit}{$ $\vspace{-7mm}}
\newcommand{\reset}{setcounter{jacob}{1}}
\newcommand{\ran}{\operatorname{ran}}
\newcommand{\changechapter}{\input{changes/to_chapter}}
\newcommand{\changesection}{\input{changes/to_section}}
\newcommand{\changesubsection}{\input{changes/to_subsection}}
\newcommand{\changedefault}{\input{changes/to_default}}