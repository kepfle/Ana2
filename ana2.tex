...
\input{inc/settings/environments_chapter}
\input{inc/settings/environments_section}
\input{inc/settings/environments_subsection}

\ifthenelse{\equal{\sectioning}{1}}{}{\ifthenelse{\equal{\subsectioning}{1}}{}{\automark[chapter]{chapter}}}%different headlines for chapter-only and sectioning

%\includeonly{content/spektrum}											% while writing your book, compile only what you need
\binoppenalty=\maxdimen
\relpenalty=\maxdimen
\allowdisplaybreaks
\begin{document}
\ifthenelse{\equal{\nulltesKapitelerzeugen}{1}}{\addtocounter{chapter}{-1}}{}
\raggedbottom
